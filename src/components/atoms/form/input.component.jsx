...
const FieldWrapper = tw.div`flex flex-col md:flex-row md:space-x-6 md:justify-between md:items-center`
const TextLabel = tw.label`w-full md:w-96 leading-7 text-gray-600 text-xl capitalize`
